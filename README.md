...
<div style="float: left; width: 50%;">
    <img src="MSBB-r2.png" alt="Model Performance MSBB" title="Model Performance MSBB" width="45%">
</div>
<div style="float: right; width: 50%;">
    <img src="ROSMAP-r2.png" alt="Model Performance ROSMAP" title="Model Performance ROSMAP" width="45%">
</div>
